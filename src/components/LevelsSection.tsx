...
const levels = [
    { id: 'epsilon', capital: 'E', name: 'Epsilon', symbol: 'ε', grades: 'Lớp 1 - 2', color: 'from-blue-400 to-blue-600', text: 'text-blue-500', bg: 'bg-blue-50', borderColor: 'border-blue-400', hoverLine: 'group-hover:bg-blue-500', delay: 0 },
    { id: 'delta', capital: 'Δ', name: 'Delta', symbol: 'δ', grades: 'Lớp 3 - 4', color: 'from-green-400 to-green-600', text: 'text-green-500', bg: 'bg-green-50', borderColor: 'border-green-400', hoverLine: 'group-hover:bg-green-500', delay: 0.1 },
    { id: 'gamma', capital: 'Γ', name: 'Gamma', symbol: 'γ', grades: 'Lớp 5 - 6', color: 'from-yellow-400 to-orange-500', text: 'text-orange-500', bg: 'bg-orange-50', borderColor: 'border-orange-400', hoverLine: 'group-hover:bg-orange-500', delay: 0.2 },
    { id: 'beta', capital: 'B', name: 'Beta', symbol: 'β', grades: 'Lớp 7 - 8', color: 'from-red-400 to-rose-600', text: 'text-rose-500', bg: 'bg-rose-50', borderColor: 'border-rose-400', hoverLine: 'group-hover:bg-rose-500', delay: 0.3 },
    { id: 'alpha', capital: 'A', name: 'Alpha', symbol: 'α', grades: 'Lớp 9 - 11', color: 'from-purple-500 to-indigo-600', text: 'text-purple-500', bg: 'bg-indigo-50', borderColor: 'border-purple-400', hoverLine: 'group-hover:bg-purple-500', delay: 0.4 },
];
            ...
            <div className="container mx-auto px-4 md:px-8 max-w-7xl relative z-10 w-full">
                ...
                >
                    ...
                    <div className="text-center mb-16">
                        <span className="text-fmc-orange font-bold tracking-wider uppercase text-lg md:text-xl mb-3 block drop-shadow-sm">Thử thách theo từng cấp độ</span>
                        <h2 className="text-3xl md:text-5xl font-black text-fmc-lime mb-6 drop-shadow-sm uppercase tracking-tight">Đối Tượng & Các Cấp Độ Thi Đấu</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                        {levels.map((level) => (
                            <motion.div
                                ...
                                className={`bg-white rounded-3xl p-6 shadow-xl shadow-gray-200/50 border-2 ${level.borderColor} flex flex-col items-center justify-center text-center relative overflow-hidden group transition-all duration-300 hover:shadow-2xl`}
                            >
                                ...
                                <p className="text-gray-600 font-bold bg-fmc-sec-1 px-4 py-2 rounded-xl w-full border border-fmc-sec-3 group-hover:bg-fmc-lime/10 transition-colors font-open-sans text-lg">
                                    {level.grades}
                                </p>
                            </motion.div>
                        ))}
